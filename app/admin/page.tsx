  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Chart */}
        <div className="lg:col-span-2 w-full min-w-0 bg-white border border-gray-200 shadow-sm rounded-xl p-6 overflow-hidden">
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-display text-lg hidden sm:block">Revenue Over Time</h3>
            <h3 className="font-display text-lg sm:hidden">Revenue</h3>
